export type AgentContext = {
    ...
    diagnostic_summary: {
        errors: number;
        warnings: number;
        invariants_preserved: number;
        invariants_blocked: number;
    };
...
export type ContextHistory = {
    schema: "axiom.context_history.v0";
...
export declare function setAxmemContextProvider(nextProvider: AxmemContextProvider): void;
export declare function clearAxmemContextProvider(): void;
export declare function readContext(cwd: string): AgentContext | undefined;
export declare function readContextHistory(cwd: string): ContextHistory;
export declare function readSessionLog(cwd: string): SessionLogEntry[];
